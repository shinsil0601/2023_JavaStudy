...
public class TestMain {
	public static void main(String[] args) {
		...
		System.out.println("1.테이블 전체 데이터보기");
		System.out.println("2.테이블 특정 데이터보기");
		System.out.println("3.테이블 삽입");
		System.out.println("4.테이블 삭제");
		System.out.println("5.테이블 수정");
		System.out.println(">>>>>>>>>>>>>");
		
		int menu = scan.nextInt();
		ArrayList<VO> list = null;  //여러개 데이터 보기
		switch (menu) {
		case 1:
		...
		case 3: 
			...
			if (result>0) {
			ArrayList<VO> list2 = null;  //여러개 데이터 보기
			list2 = DAO.getInstance().getSelectAll();
				for (VO k : list2) {
				System.out.print(k.get고객아이디()+"\t");
				System.out.print(k.get고객이름()+"\t");
				System.out.print(k.get나이()+"\t");
		...
		case 4:
			...
			if (result2>0) {
				ArrayList<VO> list3 = null;  //여러개 데이터 보기
				list3 = DAO.getInstance().getSelectAll();
					for (VO k : list3) {
					System.out.print(k.get고객아이디()+"\t");
					System.out.print(k.get고객이름()+"\t");
					System.out.print(k.get나이()+"\t");
