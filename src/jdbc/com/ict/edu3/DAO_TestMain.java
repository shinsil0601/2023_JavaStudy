...
public class DAO_TestMain {
	public static void main(String[] args) {
		...
		case 2: System.out.print("고객아이디 입력: ");
		...
		DAO.getInstance().getDelete(c_id3);
			break;
		case 5: System.out.print("삽입정보를 입력하세요");
		...
		System.out.print("고객직업: ");
		String c_job4 = scan.next();
		System.out.print("고객적립금: ");
		String c_point4 = scan.next();
		DAO.getInstance().getUpdate(c_id4,c_name4,c_age4,c_rank4,c_job4,c_point4); break;
